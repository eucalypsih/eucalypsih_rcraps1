...
isok: true<br>
func:<br>
rets: let ptrconst: *const u8 = <br>
args:<br>
ityp:<br>
iter:<br>
exam: = "액션".as_ptr(); // Get a pointer to the first byte of the string<br>
...
ityp:<br>
iter: buf_mut.<br>
exam: buf_mut.put_slice(b"액션");<br>

isok: true<br>
func:<br>
rets: let mut buf: bytes::BytesMut = <br>
args:<br>
ityp:<br>
iter:<br>
exam: _bytes_mut.extend_from_slice(b"액션");<br>
